...
export const RecentActivity = () => {
  return (
    <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl h-96 p-6 backdrop-blur-sm" data-source-path="src/components/RecentActivity.jsx">
      ...
      <div className="space-y-4 overflow-y-auto h-[calc(100%-3rem)] pr-2 custom-scrollbar">
        {[
          ...
          <div key={i} className="flex items-center space-x-4 p-3 hover:bg-slate-700/50 rounded-xl transition-all duration-200 cursor-pointer group border border-transparent hover:border-slate-600/50">
            <div className={`w-10 h-10 rounded-full flex-shrink-0 group-hover:scale-110 transition-transform ${item.color} flex items-center justify-center text-white/90 shadow-lg`}>
